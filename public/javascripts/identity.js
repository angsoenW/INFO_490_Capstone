...
async function loadIdentity(){
    ...
    try{
        ...
        if(identityInfo.status == "loggedin"){
            ...
            <a href="/api/v1/userProfile?user=${encodeURIComponent(identityInfo.userInfo.username)}">${escapeHTML(identityInfo.userInfo.name)} (${escapeHTML(identityInfo.userInfo.username)})</a>
